...
Singleton {
  ...
  component FontFamilyType: QtObject {
  ...
  component FontPixelSizeType: QtObject {
  ...
  component FontType: QtObject {
    property FontFamilyType family: FontFamilyType {}
    property FontPixelSizeType pixelSize: FontPixelSizeType {}
  }

  readonly property FontType font: FontType {}

  component RoundingType: QtObject {
  ...
  readonly property RoundingType rounding: RoundingType {}
  ...
  component AnimationElementType: QtObject {
  ...
  component AnimationType: QtObject {
    ...
    property AnimationElementType elementMoveFast: AnimationElementType {
      duration: 250
      type: Easing.InOutQuad
      velocity: 850
      colorAnimation: ColorAnimation {
  ...
  component ColorsType: JsonObject {
  ...
  FileView {
    ...
    JsonAdapter {
      ...
      property ColorsType colors: ColorsType {}
